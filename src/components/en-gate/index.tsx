...
const MODEL_PATH = "/assets/models/en-gate/en-gate.glb";
...
function EnGateModel(props: EnGateProps) {
...
export function EnGate(props: EnGateProps) {
  return (
