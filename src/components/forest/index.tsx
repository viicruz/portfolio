...
//* Local imports
import { ForestTreeColliders } from "@/components/forest/forest-tree-colliders";
...
function ForestTrees(props: ForestProps) {
  ...
  const placements = useMemo(() => resolveForestPlacements(baseY), [baseY]);

  return (
    <>
      <ForestTreeColliders placements={placements} />
      <group>
